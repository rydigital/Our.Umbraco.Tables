function tableGeneratorEditorController($scope, $routeParams)
{
	...
	{
		vm.richTextEditor = {
			view: "/App_Plugins/Our.Umbraco.TableGenerator/backoffice/views/tablegenerator.overlay.view.html",
			show: true,
...
angular.module("umbraco").controller("Our.Umbraco.TableGenerator.BackOffice.TableGenerator.Editor.Controller", tableGeneratorEditorController);